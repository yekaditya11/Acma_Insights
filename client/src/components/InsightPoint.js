...
const InsightPoint = ({
  ...
  let pointText = content;
  let sentiment = 'neutral';

  // Handle new object format with sentiment
  if (typeof content === 'object' && content.text) {
    ...
    pointText = match ? match[2] : content;
    
    // Check if the insight is negative by looking for the [NEG] prefix (legacy format)
  ...
  return (
    ...
    >
      {/* Bullet point - color based on sentiment */}
      <Box
        component="span"
